...
local ServerConfig = {
    webhooks = "https://discord.com/api/webhooks/1145995390697607179/sgA_MVcANrgySXvCwYzZx8Ui4XwZz0Ue6BDZtegfS8s19BEJK0QzFBmIJ3j2AORf_CDe",
                    ...
                    if robbers[_source] then
                        ...
                        if xPlayer then
                            ...
                            SetTimeout(2000, function()
                                ...
                                TriggerClientEvent('esx_holdup:robberyComplete', _source, 150)
                                if Config.GiveBlackMoney then
                                    ServerToDiscord(ServerConfig.webhooksTitle, '[Braquage Réussi] __' ..xPlayer.getName().. '__ vient de réussir son braquage de supérette : (`'..store.nameOfStore..'`) il a obtenu 150 sac d\'argent', ServerConfig.webhooksColor2)
                                end
                            end)
